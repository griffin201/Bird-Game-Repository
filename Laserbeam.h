#ifndef ABILITY_LASERBEAM_H
#define ABILITY_LASERBEAM_H
...
class laserbeam : public defaultAbilityClass
{
public:
	...
	*/
	...
	{
		_description[0] = "High damage, High cost";
		_description[1] = "Cant miss also";
		_description[2] = "";
	}
